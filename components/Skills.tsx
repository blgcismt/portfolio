...
const jsonLines: Seg[][] = [
  ...
  [
    ...
    { text: '"SQLAlchemy"', color: C.str }, { text: ", ", color: C.punct },
    { text: '"Alembic"',    color: C.str }, { text: ", ", color: C.punct },
    { text: '"APScheduler"',color: C.str }, { text: ", ", color: C.punct },
    { text: '"openpyxl"',   color: C.str }, { text: ", ", color: C.punct },
    { text: '"Selenium"',   color: C.str }, { text: ", ", color: C.punct },
    { text: '"Playwright"', color: C.str }, { text: ", ", color: C.punct },
    { text: '"pytest"',     color: C.str },
    { text: "],", color: C.punct },
  ],
  [
